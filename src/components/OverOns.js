      ...
      <Grid className="landing-grid">
        <Cell col={12}>
          ...
          <div className="banner-text">
            ...
            eiland, de mensen en het heerlijke eten en drinken.</p>

            <p>In 2020 hebben wij een appartement gekocht in het rustige Costa del Silencio, in het zuidelijkste
            puntje van Tenerife.
            ...
            echt thuis van huis.</p>
            
            <p>Aangezien wij beiden een fulltime baan hebben en dus niet zo vaak zelf van ons appartement
            ...
            over beschikbaarheid of overige vragen.</p>
